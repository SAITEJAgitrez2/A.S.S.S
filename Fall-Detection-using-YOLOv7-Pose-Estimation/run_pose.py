...
def run(poseweights= 'yolov7-w6-pose.pt', source='Human_Fall_Detection_Sample.mp4', device='cpu'):
    ...
    if path !=None:
        ...
        out = cv2.VideoWriter(f"{out_video_name}_result.mp4", cv2.VideoWriter_fourcc(*'mp4v'), 24, (resize_width, resize_height))
        ...
        while cap.isOpened:
            ...
            if ret:
                ...
                icon = cv2.imread("white_warning_logo.jpg")
                ...
                for idx in range(output.shape[0]):
                    ...
                    if ((difference > 0) and (int(chest) > thre)) or (difference < 0):
                        ...
                        draw_border(img, pt1, pt2, (255, 255, 255), 1) #img, pt1, pt2, color, thickness)(84, 61, 247(redish))
